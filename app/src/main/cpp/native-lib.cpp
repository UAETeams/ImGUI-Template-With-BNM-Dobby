...
#define BNM_METHOD_OFFSET(Namespace, Clasz, Method, Count) Class(Namespace, Clasz).GetMethod(BNM_OBFUSCATE(Method), Count).GetOffset()
#define OBFBNM_C(Namespace, Clasz) Class(Namespace, Clasz)
#define GetFieldOffset(offset,classs,field) offset = classs.GetField(field).GetOffset();
#define HOOK_BNM(Namespace,Clasz,Method,Count, Func_H, Func_O) DobbyHook((void*)(Class(Namespace, Clasz).GetMethod(BNM_OBFUSCATE(Method), Count).GetOffset()), (void*)Func_H, (void**)&Func_O);
...
void (*WriteAllText) (void* instance, BNM::Structures::Mono::String* path, BNM::Structures::Mono::String* content);

void (*DebugFinishTask) (void* instance);

void FunctionPointers64()
{
    DebugFinishTask = (void(*)(void*)) getAbsoluteAddress(targetLibName, 0x2594278);
    WriteAllText = (void(*)(void*, BNM::Structures::Mono::String*, BNM::Structures::Mono::String*)) (getAbsoluteAddress(targetLibName, 0x44DE238));
}
void FunctionPointers32()
{
    DebugFinishTask = (void(*)(void*)) getAbsoluteAddress(targetLibName, 0x2594278);
    WriteAllText = (void(*)(void*, BNM::Structures::Mono::String*, BNM::Structures::Mono::String*)) getAbsoluteAddress(targetLibName, 0x34D706C);
}
...
void (*AddMoneyToPlayer_o)(void *instance, int32_t Ammount);
void AddMoneyToPlayer_h(void *instance, int32_t Ammount)
{
    Ammount = 9999999999;
    DebugFinishTask(instance);
    return AddMoneyToPlayer_o(instance, Ammount);
}
...
//////////////////////
    ...
    HOOK_BNM("Nekki.Currency","CurrencyManager","AddMoney",2, AddMoneyToPlayer_h, AddMoneyToPlayer_o);

    auto Screen_get_height_Offset = BNM_METHOD_OFFSET("UnityEngine", "Screen", "get_height", 0);
    auto Screen_get_width_Offset = BNM_METHOD_OFFSET("UnityEngine", "Screen", "get_width", 0);
    ...
    uint32_t PlayerID_Offset = 0x0; /// trying to get the offset of playerID

    auto PlayerClass = OBFBNM_C("Nekki.PlayerManager","PlayerClass"); /// this is not an offset

    GetFieldOffset(PlayerID_Offset, PlayerClass, "_PlayerID");
...
void lib_main() {
    ...
    pthread_t ptid;
    pthread_create(&ptid, NULL, MainHooks, NULL);
